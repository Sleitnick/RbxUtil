...
| [TypedRemote](https://sleitnick.github.io/RbxUtil/api/TypedRemote) | `TypedRemote = "sleitnick/typed-remote@0.1.0"` | Simple networking package for typed RemoteEvents and RemoteFunctions |
