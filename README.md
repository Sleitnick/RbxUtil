...
| [Net](https://sleitnick.github.io/RbxUtil/api/Net) | `Net = "sleitnick/net@0.2.1"` | Static networking module |
...
| [Trove](https://sleitnick.github.io/RbxUtil/api/Trove) | `Trove = "sleitnick/trove@1.5.1"` | Trove class for tracking and cleaning up objects |
| [TypedRemote](https://sleitnick.github.io/RbxUtil/api/TypedRemote) | `TypedRemote = "sleitnick/typed-remote@0.2.1"` | Simple networking package for typed RemoteEvents and RemoteFunctions |
